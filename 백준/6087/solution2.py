        ...
        for i in range(4):
            ...
            if 0 <= nx < N and 0 <= ny < M and _map[nx][ny] != '*':
                ...
                if dir != '' and nxt_dir != dir:
                    nxt_cnt += 1
                # 최소 경로만 탐색
                if nxt_cnt < visited[nx][ny][0] or (nxt_cnt == visited[nx][ny][0] and nxt_dir != visited[nx][ny][1]):
                # if nxt_cnt < visited[nx][ny][0]:
                    visited[nx][ny][0] = nxt_cnt
                    visited[nx][ny][1] = nxt_dir
